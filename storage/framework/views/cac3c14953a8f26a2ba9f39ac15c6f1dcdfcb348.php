                ...
                <div class="card-body">
                    <div class="row">
                        <div style="font-size: 16px;" class="col-md-10 offset-md-1">
                            ...
                            <p><?php echo e($app_name); ?> ("We") respects your privacy and is committed to protecting it through our compliance with this policy.</p>
                            ...
                            <p>This policy describes the types of information we may collect from you or that you may provide when you visit the website
                                <a target="_blank" href="<?php echo e($app_url); ?>"><?php echo e($app_url); ?></a> (our "Website") and our practices for collecting, using, maintaining, protecting, and disclosing that information.</p>
                           ...
                           <p> We do not knowingly collect personal information from children under 13. If you are under 13, do not provide any information on this Website or on or through any of its features without first obtaining parental consent. If we learn we have collected or received personal information from a child under 13 without verification of parental consent, we will delete that information. If you believe we might have any information from or about a child under 13, please call <?php echo e($contact_phone); ?></p>
                            ...
                            <ul>
                                ...
                                <li>To enforce or apply our <a target="_blank" href="<?php echo e(route('terms_of_use')); ?>">Terms of Use</a>.</li>
                           ...
                           <p>It is our policy to post any changes we make to our privacy policy on this page. If we make material changes to how we treat our users' personal information, we will notify you through a notice on the Website home page. The date the privacy policy was last revised is identified at the top of the page. You are responsible for periodically visiting our Website and this privacy policy to check for any changes.</p>
                            ...
                            <p>To ask questions or comment about this privacy policy and our privacy practices, please call <?php echo e($contact_phone); ?></p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.login_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SMS-IN-LARAVEL\resources\views/pages/other/privacy_policy.blade.php ENDPATH**/ ?>