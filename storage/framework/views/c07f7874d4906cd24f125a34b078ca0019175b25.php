                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                ...
                                <h5 class="mb-0">LOGIN TO BEGIN YOUR SESSION</h5>
                                <span class="d-block text-muted">Your email and password</span>
                            </div>
...
<?php echo $__env->make('layouts.login_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SMS-IN-LARAVEL\resources\views/auth/login.blade.php ENDPATH**/ ?>